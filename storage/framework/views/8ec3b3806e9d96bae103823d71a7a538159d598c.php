					...
					<div class="widget-content">
						<?php if($page != NULL): ?>
							<form class="ui form" id="create-category" method="post"
								  action="<?php echo e(route('pages.update')); ?>" enctype="multipart/form-data">
									...
									<div class="ui field">
										...
										<div class="ui input">
											<input name="ar_title" id="ar_title" type="text"
												   placeholder="الصفحة باللغة العربية" value="<?php echo e($page->ar_title); ?>"/>
										</div>
									</div>
									...
									<div class="ui field">
										...
										<div class="ui input">
											<input name="en_title" id="en_title" type="text"
												   ...
												   value="<?php echo e($page->en_title); ?>"/>
										</div>
									</div>
									...
									<div class="ui field">
										...
										<div class="ui input">
											<select name="active">
												...
												<option value="1" <?php echo e($page->active == 1 ? 'selected' : ''); ?>>مفعلة
												</option>
												<option value="0" <?php echo e($page->active == 0 ? 'selected' : ''); ?>> غير
													مفعلة
												</option>
											</select>
										</div>
