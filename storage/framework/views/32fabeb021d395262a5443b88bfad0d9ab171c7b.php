        ...
        <section class="page-heading">
            ...
            <div class="col-sm-6">
                <ul class="breadcrumb">
                    ...
                    <li> <a href="<?php echo e(route('provider.show')); ?>">المتاجر </a></li>
            ...
            <div class="widget">
                ...
                <div class="widget-content">
                    ...
                    <div class="form-title"> نشر المتجر  :<span class="require">*</span></div>
                        <div class="form-group  <?php if($errors->has('publish')): ?> error  <?php endif; ?>">
                            <select   class="form-control" name="publish">
                                    <option> اختر  حالة  </option>
                                
                                        <option value="1" <?php  if($provider  -> publish    == 1 ) { echo 'selected';  }     ?> > نعم </option>

                                         <option value="0" <?php  if($provider  -> publish    == 0 ) { echo 'selected';  }     ?> > لا  </option>
