        ...
        <section class="page-heading">
            ...
            <div class="col-sm-6">
                <ul class="breadcrumb">
                    ...
                    <li ><a href="<?php echo e(route('deliveries.show')); ?>">الموصلين </a></li>
        ...
        <div class="col-md-12">
            <div class="widget">
                ...
                <div class="widget-content">
                    <form class="ui form" enctype="multipart/form-data"   method="post" action="<?php echo e(route('deliveries.update')); ?>">
                      <input type="hidden" name="delivery_id" value="<?php echo e($delivery -> delivery_id); ?>">
                        ...
                        <div class="widget-title">
                            البيانات الشخصية
                             ...
                             <div class="ui field <?php if($errors->has('full_name')): ?> error  <?php endif; ?>">
                                ...
                                <div class="ui input">
                                    <input name="full_name" id="full_name" type="text" placeholder="الاسم بالكامل " value="<?php echo e($delivery -> full_name); ?>" />
                                </div>
                        ...
                        <div class="two fields">
                         ...
                         <div>
                           ...
                           <input type="hidden" id="latitudef" value="<?php echo e($delivery -> latitude); ?>"  name="latitude">
                           <input type="hidden" id="longitudef"  value="<?php echo e($delivery -> latitude); ?>" name="longitude">
                        ...
                        <div class="ui field" >
                            ...
                            <div class="inline-form">
                                ...
                                <div class="form-group col-md-1 col-sm-2">
                                    <input class="form-control country_code" value="<?php echo e($delivery -> country_code); ?>" placeholder="مثال : 202" maxlength="4" name="country_code" id="country_code" type="text">
                             ...
                             <div class="<?php if($errors->has('phone')): ?> error  <?php endif; ?>">
                                <div class="form-group col-md-11 col-sm-10">
                                    <input class="form-control phone" value="<?php echo e($delivery -> phone); ?>" name="phone" id="phone" placeholder="مثال : 05xxxxxxxx" maxlength="11" type="text">
                                      <div class="error-messagen">
                        ...
                        <div>
                            <div class="ui field <?php if($errors->has('car_number')): ?> error  <?php endif; ?>">
                                ...
                                <div class="ui input">
                                    <input name="car_number" id="car_number" type="text" placeholder=" رقم  السيارة" value="<?php echo e($delivery ->  car_number); ?>" />
                                </div>
   ...
   $('#longitudef').val('');
      ...
      function initAutocomplete() {
        var map = new google.maps.Map(document.getElementById('map'), {
          center: {lat: "<?php echo e($delivery  -> latitude); ?>", lng: "<?php echo e($delivery  -> longitude); ?>" },
          zoom: 19,
          mapTypeId: 'roadmap'
        });
