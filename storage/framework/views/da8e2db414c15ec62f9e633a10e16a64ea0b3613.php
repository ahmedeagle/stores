        ...
        <div class="col-md-12">
            <div class="widget">
                ...
                <div class="widget-content">
                    <form class="ui form" id="create-providerr" method="post" action="<?php echo e(route('provider.store')); ?>" enctype="multipart/form-data">
                        ...
                        <div class="two fields">
                            ...
                            <div class="ui field <?php if($errors->has('store_name')): ?> error  <?php endif; ?>">
                                ...
                                <div class="ui input">
                                    <input name="store_name" id="store_name" type="text" placeholder="الأسم المتجر " value="<?php echo e(old('store_name')); ?>" />
                                    ...
                                    <select class="ui dropdown country" id="countries" name="country_id">
                                        ...
                                        <?php if($countries->count()): ?>
                                            <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option id="<?php echo e(old('country_id')); ?>" value="<?php echo e($country->country_id); ?>" 
                                                        <?php  if(old('country_id')  == $country->country_id ) { echo 'selected';  }     ?> 

                                                    ><?php echo e($country->country_en_name); ?></option>
                        ...
                        <div class="inline-form ui field">
                            ...
                            <div class="ui input col-md-2 col-sm-3 <?php if($errors->has('country_code')): ?> error  <?php endif; ?>">
                                <input class="form-control country_code" id="country_code" value="<?php echo e(old('country_code')); ?>" placeholder="مثال : 996,20" type="text" name="country_code">
                                   <div class="error-messagen">
                            ...
                            <div class="ui input col-md-8 col-sm-7 <?php if($errors->has('phone')): ?> error  <?php endif; ?>">
                                <input class="form-control phone" id="phone" value="<?php echo e(old('phone')); ?>" placeholder="مثال : 05xxxxxxxx" type="text" name="phone">
                                <div class="error-messagen">
                                    ...
                                    <select class="ui dropdown"  name="membership_id">
                                        ...
                                        <?php if(isset($types) && $types -> count() > 0): ?>
                                            <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($type->membership_id); ?>"   <?php  if(old('membership_id')  == $type->membership_id ) { echo 'selected';  }     ?> 
                            ...
                            <select   class="form-control" name="category_id">
                                ...
                                <?php if(isset($categories) && $categories->count() > 0): ?>
                                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($category->cat_id); ?>" <?php  if(old('cat_id')  == $category->cat_id ) { echo 'selected';  }     ?> ><?php echo e($category->cat_ar_name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endif; ?>
                            </select>
                            <div class="error-messagen">
                        ...
                        <div class="form-group <?php if($errors->has('delivery_method')): ?> error  <?php endif; ?>">
                            <select id="delivery_method" multiple class="form-control multipart" name="delivery_method[]">
                                ...
                                <?php if(isset($delivery_methods) && $delivery_methods->count() > 0): ?>
                                    <?php $__currentLoopData = $delivery_methods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $method): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option  value="<?php echo e($method->method_id); ?>" <?php  if(old('method_id')  == $method->method_id ) { echo 'selected';  }     ?> ><?php echo e($method->method_ar_name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endif; ?>
                            </select>
                          ...
                          <div class="ui field <?php if($errors->has('delivery_price')): ?> error  <?php endif; ?>" id="delivery_price" >
                                ...
                                <div class="ui input">
                                    <input name="delivery_price" type="text" placeholder=" قم بادخال تكلفه التوصيل مثال   10 " value="<?php echo e(old('delivery_price')); ?>" />
                                </div>
                                <div class="error-messagen">
