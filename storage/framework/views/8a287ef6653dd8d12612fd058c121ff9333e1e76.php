				...
				<ul class="side-menu-links">
					...
					<li class="sub-menu">
						...
						<ul>
							...
							<li>
								<a rel="nofollow" rel="noreferrer" href="<?php echo e(route('create_admin')); ?>">إضافة مدير
									جديد </a>
							</li>
						</ul>
					</li>
					...
					<li class="sub-menu">
						...
						<ul>
							<li>
								<a rel="nofollow" rel="noreferrer" href="<?php echo e(route('provider.show')); ?>">قائمة مقدمى
									الخدمة</a>
							</li>
							<li>
								<a rel="nofollow" rel="noreferrer" href="<?php echo e(route('provider.create')); ?>">إضافة مقدم
									خدمة</a>
							</li>
							<li>
					...
					<li class="sub-menu">
						...
						<ul>
							...
							<li>
								<a rel="nofollow" rel="noreferrer" href="<?php echo e(route('offers.reports')); ?>"> تقارير
									ألعروض </a>
							</li>
					...
					<li class="sub-menu">
						...
						<ul>
							<li>
								<a rel="nofollow" rel="noreferrer" href="<?php echo e(route('excellent.show')); ?>"> قائمه
									الطلبات </a>
							</li>


							<li>
								<a rel="nofollow" rel="noreferrer" href="<?php echo e(route('excellent.reports')); ?>"> تقارير
									الطلبات </a>
							</li>
					...
					<li class="sub-menu">
						...
						<ul>
							<li>
								<a rel="nofollow" rel="noreferrer" href="<?php echo e(route('deliveries.show')); ?>">قائمة
									الموصلين</a>
							</li>
							<li>
								<a rel="nofollow" rel="noreferrer" href="<?php echo e(route('deliveries.create')); ?>">إضافة
									موصل</a>
							</li>
							<li>
								<a rel="nofollow" rel="noreferrer" href="<?php echo e(route('delivery.income.show')); ?>">قائمة
									إيرادات الموصلين</a>
							</li>
						</ul>
					</li>
					<li class="sub-menu">
						...
						<ul>
							<li>
								<a rel="nofollow" rel="noreferrer" href="<?php echo e(route('category.show')); ?>">قائمة
									التصنفيات</a>
							</li>
							<li>
								<a rel="nofollow" rel="noreferrer" href="<?php echo e(route('category.create')); ?>">إضافة تصنيف
									جديد</a>
							</li>
						</ul>
					</li>
					...
					<li class="sub-menu">
						...
						<ul>
							<li>
								<a rel="nofollow" rel="noreferrer" href="<?php echo e(route('requests.today')); ?>">عمليات السحب
									اليومية</a>
							</li>
							<li>
								<a rel="nofollow" rel="noreferrer" href="<?php echo e(route('requests.show')); ?>">قائمة عمليات
									السحب</a>
							</li>
						</ul>
					</li>
					<li class="sub-menu">
						...
						<ul>
							<li>
								<a rel="nofollow" rel="noreferrer" href="<?php echo e(route('invoices.filter')); ?>">قائمة
									الفواتير</a>
							</li>
							<li>
								<a rel="nofollow" rel="noreferrer" href="<?php echo e(route('invoices.create')); ?>">إنشاء
									فاتورة</a>
							</li>
						</ul>
					</li>
					...
					<li class="sub-menu">
						...
						<ul>
							<li>
								<a rel="nofollow" rel="noreferrer" href="<?php echo e(route('pages.create')); ?>">إضافة صفحة</a>
							</li>
							<li>
								<a rel="nofollow" rel="noreferrer" href="<?php echo e(route('pages.index')); ?>">قائمة الصفحات</a>
							</li>
						</ul>
					</li>
					...
					<li class="sub-menu">
						...
						<ul>
							<li>
								<a rel="nofollow" rel="noreferrer" href="<?php echo e(route('comments.today')); ?>">التعليقات
									اليومية</a>
							</li>
							<li>
								<a rel="nofollow" rel="noreferrer" href="<?php echo e(route('comments.show')); ?>">قائمة
									التعليقات</a>
							</li>
						</ul>
					</li>
					...
					<li class="sub-menu">
						...
						<ul>
							<li>
								<a rel="nofollow" rel="noreferrer" href="<?php echo e(route('provider.evaluations.show')); ?>">تقييمات
									المتاجر </a>
							</li>
							<li>
								<a rel="nofollow" rel="noreferrer" href="<?php echo e(route('delivery.evaluations.show')); ?>">تقييمات
									الموصلين</a>
							</li>
						</ul>
					</li>
					...
					<li class="sub-menu">
						...
						<ul>
							<li>
								<a rel="nofollow" rel="noreferrer" href="<?php echo e(route('admin.notifications.list')); ?>">
									الاشعارات المرسله </a>
							</li>
							<li>
								<a rel="nofollow" rel="noreferrer" href="<?php echo e(route('get.notifications')); ?>"> ارسال اشعار
									جديد </a>
							</li>
						</ul>
					</li>
