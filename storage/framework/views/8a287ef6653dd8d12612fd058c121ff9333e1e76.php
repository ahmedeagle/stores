                    ...
                    <aside class="sidebar">
                        <ul class="side-menu-links">
                          ...
                          <li class="sub-menu">
                                ...
                                <ul>
                                    <li>
                                        <a rel="nofollow" rel="noreferrer" href="<?php echo e(route('admin.notifications.list')); ?>"> الاشعارات المرسله </a>
                                    </li>
                                    <li>    
                                        <a rel="nofollow" rel="noreferrer" href="<?php echo e(route('get.notifications')); ?>"> ارسال اشعار جديد </a>
                                    </li>
                                </ul>
                            </li>
