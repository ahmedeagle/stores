                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody id="tableBody">
                            ...
                            <tr>
                                ...
                                <td><?php echo e($request->country_code.$request->person_phone); ?></td>
                                <td><?php echo e($request->due_balance); ?></td>
                                <td><?php echo e($request->current_balance); ?></td>
                                <td><?php echo e($request->forbidden); ?></td>
                                <td><?php echo e($request->current_balance - $request->due_balance - $request->forbidden); ?></td>
                                <td><?php echo e((is_null($request->name))? '' : $request->name); ?></td>
                                <td><?php echo e((is_null($request->bank_name))? '' : $request->bank_name); ?></td>
                                <td><?php echo e((is_null($request->account_num))? '' : $request->account_num); ?></td>
                                <td><?php echo e((is_null($request->phone))? '' : $request->phone); ?></td>
