        ...
        <div class="col-md-12">
            <div class="widget">
                ...
                <div class="widget-content">
                    <form class="ui form" id="create-admin" method="post" action="<?php echo e(route('admin.store')); ?>">
                        ...
                        <?php if(Session::has('msg')): ?>
                            <div class="alert alert-success">
                                <strong>نجاح !</strong> <?php echo e(Session::get('msg')); ?>
                        ...
                        <div>
                            <div class="ui field">
                                ...
                                <div class="ui input">
                                    <input name="name" id="name" type="text" placeholder="إسم المدير بالكامل" value="<?php echo e(old('name')); ?>" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            <div class="ui field">
                                ...
                                <div class="ui input">
                                    <input name="email" id="email" type="text" placeholder="البريد الألكترونى" value="<?php echo e(old('email')); ?>" />
                                </div>
                            </div>
                        </div>
                        <div class="two fields">
                            <div class="ui field">
                                ...
                                <div class="ui input">
                                    <input name="password" id="password" type="text" placeholder="كلمة المرور" value="<?php echo e(old('password')); ?>" />
                                </div>
                            </div>
                            <div class="ui field">
                                <label>تأكيد كلمة المرور : <span class="require">*</span></label>
                                <div class="ui input">
                                    <input name="passwordcon" id="passwordcon" type="text" placeholder="تأكيد كلمة المرور" value="<?php echo e(old('passwordcon')); ?>" />
                                </div>
                            </div>
                        </div>
