                        ...
                        <div class="two fields">
                            <div class="ui field">
                               <label>الصفحة باللغة الإنجليزية<span class="require">*</span></label>
                                <div class="ui input">
                                    <input name="en_title" id="en_title" type="text" placeholder="الصفحة باللغة الأنجليزية" value="{{ $page->en_title }}" />
                                </div>
                            </div>
                            <div class="ui field">
                                <label>الصفحة باللغة العربية<span class="require">*</span></label>
                                <div class="ui input">
                                    <input name="ar_title" id="ar_title" type="text" placeholder="الصفحة باللغة العربية" value="{{ $page->ar_title }}" />
                                </div>
                            </div>
                        </div>
