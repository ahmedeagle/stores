				...
				<ul class="side-menu-links">
					...
					<li class="sub-menu">
						...
						<ul>
							...
							<li>
								<a rel="nofollow" rel="noreferrer" href="{{  route('create_admin') }}">إضافة مدير
									جديد </a>
							</li>
						</ul>
					</li>
					...
					<li class="sub-menu">
						...
						<ul>
							<li>
								<a rel="nofollow" rel="noreferrer" href="{{ route('provider.show') }}">قائمة مقدمى
									الخدمة</a>
							</li>
							<li>
								<a rel="nofollow" rel="noreferrer" href="{{ route('provider.create') }}">إضافة مقدم
									خدمة</a>
							</li>
							<li>
					...
					<li class="sub-menu">
						...
						<ul>
							...
							<li>
								<a rel="nofollow" rel="noreferrer" href="{{ route('offers.reports') }}"> تقارير
									ألعروض </a>
							</li>
					...
					<li class="sub-menu">
						...
						<ul>
							<li>
								<a rel="nofollow" rel="noreferrer" href="{{ route('excellent.show') }}"> قائمه
									الطلبات </a>
							</li>


							<li>
								<a rel="nofollow" rel="noreferrer" href="{{ route('excellent.reports') }}"> تقارير
									الطلبات </a>
							</li>
					...
					<li class="sub-menu">
						...
						<ul>
							<li>
								<a rel="nofollow" rel="noreferrer" href="{{ route('deliveries.show') }}">قائمة
									الموصلين</a>
							</li>
							<li>
								<a rel="nofollow" rel="noreferrer" href="{{ route('deliveries.create') }}">إضافة
									موصل</a>
							</li>
							<li>
								<a rel="nofollow" rel="noreferrer" href="{{ route('delivery.income.show') }}">قائمة
									إيرادات الموصلين</a>
							</li>
						</ul>
					</li>
					<li class="sub-menu">
						...
						<ul>
							<li>
								<a rel="nofollow" rel="noreferrer" href="{{ route('category.show') }}">قائمة
									التصنفيات</a>
							</li>
							<li>
								<a rel="nofollow" rel="noreferrer" href="{{ route('category.create') }}">إضافة تصنيف
									جديد</a>
							</li>
						</ul>
					</li>
					...
					<li class="sub-menu">
						...
						<ul>
							<li>
								<a rel="nofollow" rel="noreferrer" href="{{ route('requests.today') }}">عمليات السحب
									اليومية</a>
							</li>
							<li>
								<a rel="nofollow" rel="noreferrer" href="{{ route('requests.show') }}">قائمة عمليات
									السحب</a>
							</li>
						</ul>
					</li>
					<li class="sub-menu">
						...
						<ul>
							<li>
								<a rel="nofollow" rel="noreferrer" href="{{ route('invoices.filter') }}">قائمة
									الفواتير</a>
							</li>
							<li>
								<a rel="nofollow" rel="noreferrer" href="{{ route('invoices.create') }}">إنشاء
									فاتورة</a>
							</li>
						</ul>
					</li>
					...
					<li class="sub-menu">
						...
						<ul>
							<li>
								<a rel="nofollow" rel="noreferrer" href="{{ route('comments.today') }}">التعليقات
									اليومية</a>
							</li>
							<li>
								<a rel="nofollow" rel="noreferrer" href="{{ route('comments.show') }}">قائمة
									التعليقات</a>
							</li>
						</ul>
					</li>
					<li class="sub-menu">
						...
						<ul>
							<li>
								<a rel="nofollow" rel="noreferrer" href="{{ route('provider.evaluations.show') }}">تقييمات
									المتاجر </a>
							</li>
							<li>
								<a rel="nofollow" rel="noreferrer" href="{{ route('delivery.evaluations.show') }}">تقييمات
									الموصلين</a>
							</li>
						</ul>
					</li>
					...
					<li class="sub-menu">
						...
						<ul>
							<li>
								<a rel="nofollow" rel="noreferrer" href="{{ route('admin.notifications.list') }}">
									الاشعارات المرسله </a>
							</li>
							<li>
								<a rel="nofollow" rel="noreferrer" href="{{ route('get.notifications') }}"> ارسال اشعار
									جديد </a>
							</li>
						</ul>
					</li>
					...
					<li class="sub-menu">
						...
						<ul>
							<li>
								<a rel="nofollow" rel="noreferrer" href="{{ route('tickets',2) }}">المتاجر </a>
							</li>
							<li>
								<a rel="nofollow" rel="noreferrer" href="{{ route('tickets',1) }}">المستخدمين </a>
							</li>

							<li>
								<a rel="nofollow" rel="noreferrer" href="{{ route('tickets',3) }}">الموصلين </a>
							</li>
						</ul>
					</li>
