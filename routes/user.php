...
Route::group(['middleware' => ['api_auth', 'CheckPhone'], 'prefix' => 'api'], function () {
    ...
    Route::post('/filterStores', 'UserController@filterStores');
    Route::get('/filterStores', 'UserController@echoEmpty');
    ...
    Route::post('/getUserInvitationCode', 'UserController@getUserInvitationCode');
    Route::get('/getUserInvitationCode', 'UserController@echoEmpty');
